...
>
  ...
  >
    ...
    <div class="flex items-center gap-4">
      <a href="/" class="text-sm font-medium text-neutral-500 hover:text-orange-500 transition-colors">Volver al inicio</a>
    </div>
  </header>
  ...
  <main class="flex-1 flex overflow-hidden">
    ...
    {:else}
      ...
      >
        ...
        <!-- Editor Title -->
        <div
          class="px-4 py-2 bg-neutral-50 dark:bg-neutral-800/80 border-b border-neutral-200 dark:border-neutral-700 flex justify-between items-center"
        >
          <div class="flex items-center gap-2">
            <Type class="w-4 h-4 text-neutral-400" />
            <span class="text-xs font-bold text-neutral-500 uppercase"
              >Editor de Código</span
            >
          </div>
        </div>
